...
class GestureDetails {
  ...
  GestureDetails(this.globalPosition, this.localPosition);

  factory GestureDetails.fromLongPressDetails(LongPressStartDetails details) {
    return GestureDetails(details.globalPosition, details.localPosition);
  }

  factory GestureDetails.fromTapUpDetails(TapUpDetails details) {
    return GestureDetails(details.globalPosition, details.localPosition);
  }

  TapPosition toTapPosition() => TapPosition(globalPosition, localPosition);
}
